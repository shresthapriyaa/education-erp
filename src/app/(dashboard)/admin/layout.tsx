...
//   BookMarked, Trophy, UserCheck, Briefcase, School,
//   CalendarDays, MessageSquare, Bell, DollarSign,
//   Library, MapPin, Home, BarChart2, UsersRound
// } from "lucide-react";
...
//           submenu: [
//             { label: "Schools",      href: "/admin/schools",     icon: <School   className="w-4 h-4" /> },
//             { label: "School Zones", href: "/admin/schoolzones", icon: <MapPin   className="w-4 h-4" /> },
//             { label: "Classes",      href: "/admin/classes",     icon: <Home     className="w-4 h-4" /> },
...
//           submenu: [
//             { label: "Schedule",    href: "/admin/schedules",   icon: <CalendarDays className="w-4 h-4" /> },
//             { label: "Lessons",     href: "/admin/lessons",     icon: <BookMarked   className="w-4 h-4" /> },
//             { label: "Assignments", href: "/admin/assignments", icon: <FileText     className="w-4 h-4" /> },
//           ],
//         },
...
//           submenu: [
//             { label: "Exams",   href: "/admin/exams",   icon: <ClipboardList className="w-4 h-4" /> },
//             { label: "Grades",  href: "/admin/grades",  icon: <BarChart2     className="w-4 h-4" /> },
//             { label: "Results", href: "/admin/results", icon: <Trophy        className="w-4 h-4" /> },
//           ],
//         },
...
//           submenu: [
//             { label: "Announcements", href: "/admin/announcements", icon: <Bell          className="w-4 h-4" /> },
...
import {
  ...
  BookMarked, Trophy, UserCheck, Briefcase, School,
  CalendarDays, MessageSquare, Bell, DollarSign,
  Library, Home, BarChart2, UsersRound
} from "lucide-react";
  ...
  const menu: MenuSectionConfig[] = [
    {
      ...
      items: [
...

        {
          ...
          icon: <BookMarked className="w-5 h-5" />,
          submenu: [
            { label: "Routines",    href: "/admin/routines",    icon: <CalendarDays className="w-4 h-4" /> },
            { label: "Lessons",     href: "/admin/lessons",     icon: <BookMarked className="w-4 h-4" /> },
            { label: "Assignments", href: "/admin/assignments", icon: <FileText   className="w-4 h-4" /> },
          ],
        },
