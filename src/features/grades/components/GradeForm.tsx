...
interface StudentOption    { id: string; username: string; email: string }
interface AssignmentOption { id: string; title: string }
  ...
  return (
    <Form {...form}>
      <form className="space-y-4">
        ...
        <FormField control={form.control as any} name="assignmentId" render={({ field }) => (
          <FormItem>
            <FormLabel>Assignment</FormLabel>
            <Select onValueChange={field.onChange} value={field.value}>
              <FormControl>
        ...
        <FormField control={form.control as any} name="score" render={({ field }) => (
          <FormItem>
            <FormLabel>Score (0 – 100)</FormLabel>
            <FormControl>
