    ...
    <TooltipProvider>
      <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Select
              ...
              onValueChange={(v) =>
                onFilterChange({
                  ...filters,
                  isVerified: v === "all" ? "all" : v === "verified" ? true : false,
                })
              }
            >
              <SelectTrigger className="h-9 w-[130px] text-sm bg-background">
        ...
        {users.length === 0 ? (
          ...
          <>
            {/* ── Desktop table ── */}
            <div className="hidden md:block rounded-xl border-t-4 border-b-4 bg-card overflow-hidden shadow-sm">
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/40 hover:bg-muted/40">
                      <TableHead className="w-[160px] text-xs font-semibold uppercase tracking-wide text-black">ID</TableHead>
                      <TableHead className="w-[180px] text-xs font-semibold uppercase tracking-wide text-black">Username</TableHead>
                      <TableHead className="w-[240px] text-xs font-semibold uppercase tracking-wide text-black">Email</TableHead>
                      <TableHead className="w-[120px] text-center text-xs font-semibold uppercase tracking-wide text-black">Status</TableHead>
                      <TableHead className="w-[130px] text-xs font-semibold uppercase tracking-wide text-black">Role</TableHead>
                      <TableHead className="w-[100px] text-center text-xs font-semibold uppercase tracking-wide text-black">Password</TableHead>
                      <TableHead className="w-[100px] text-right pr-5 text-xs font-semibold uppercase tracking-wide text-black">Actions</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {users.map((user) => (
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 border border-gray-300 bg-white text-black hover:bg-gray-100"
                        onClick={() => onEdit(user)}
                      >
                        <Pencil className="h-3.5 w-3.5" />
                      </Button>
