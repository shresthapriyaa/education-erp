...
//       await onEdit(selectedStudent.id, values, mode);
//       setEditOpen(false);
//       setSelectedStudent(null); // ✅ clear stale state after edit
//     } finally {
//       setActionLoading(false);
//     }
//   };
...
//       await onDelete(selectedStudent.id);
//       setDeleteOpen(false);
//       setSelectedStudent(null); // ✅ clear stale state after delete
//     } finally {
//       setActionLoading(false);
//     }
//   };
...
export function StudentTable({
  ...
  const AvatarCell = ({ img, username, size = "md" }: { img?: string | null; username: string; size?: "md" | "sm" }) => {
